...
function theme_support() {
  ...
  add_image_size('productS', 500, 313, true);
}
...
function register_post_types() {
  register_post_type('product', [
    'labels' => [
      ...
      'menu_name'          => 'Товары', // название меню в админ панели 
    ],
...
//подсвечиваем пункт меню товары у категории товаров
...
$admin_email = 'pizzawp@cc75916.tmweb.ru';
