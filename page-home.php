...
<!--проверка галереи на странице test -->
<!-- <?php 
  $test_gallery = carbon_get_post_meta(21, 'gallery');
?>
...
?>
  <div class="catalog__item" data-category="mushrooms">
    <div class="product catalog__product">
      <picture>
        <source type="image/webp" srcset="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-srcset="<?php echo $img_src_webp; ?>">
        <img class="product__img lazy" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="<?php echo $img_src; ?>" alt="">
      </picture>
    </div>
  </div>
<?php endforeach; ?> -->
...
<section class="section section-catalog js-section-catalog" id="section-catalog">
  <div class="container">
    ...
    <?php
      ...
      $catalog_products_query = new WP_Query( $catalog_products_query_args ); // запрос
    ?>
    ...
    <div class="section-catalog__footer">
      <a href="<?php echo get_site_url() . '/products'; ?>" class="link">перейти в каталог</a>
    </div>
...
<section class="section section-about" id="section-about">
  <picture>
    ...
    <img class="section-about__img lazy" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="<?php echo $about_img_src; ?>" alt="">
  </picture>
  <div class="container section-about__container">
    <div class="section-about__content">
      ...
      <div class="section-about__text">
        <?php echo apply_filters('the_content',carbon_get_post_meta( $page_id, 'about_text' )); ?>
      </div>
    </div>
  </div>
</section>
