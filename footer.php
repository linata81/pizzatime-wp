    ...
    <div class="popup__inner">
      <div class="popup__content">
        ...
        <div class="cart js-cart-wrapper">
          <form class="form cart__form form-send" method="POST" action="/cart/">
            <div class="cart--items js-cart">
            </div>
            <div class="cart__totals">
              <div>
                Итого:<span class="js-cart-total-price cart__bold"></span>
                <span class="cart__bold">&#8381;</span>
              </div>
            </div>
            <div class="order">
...
<button class="cart-btn" data-popup="popup-order">
  <span class="cart-btn__counter js-cart-total-coutn-items">0</span>
