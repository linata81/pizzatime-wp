...
<?php
  ...
  $product_img_src = get_the_post_thumbnail_url($product_id, 'productS'); 
      ...
      <div class="single-page__content">
        <div class="product js-product" data-product-name="<?php the_title(); ?>" data-product-price="<?php echo $product_price; ?>" <?php echo $product_data_attribute; ?> data-product-src="<?php echo get_the_post_thumbnail_url($product_id, 'product'); ?>">
          <picture>
            ...
            <img class="product__img product__img_large lazy" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="<?php echo $product_img_src; ?>" alt="">
          </picture>
